...
time reparameterization. The inverse transformation is  
\begin{subequations}
\begin{eqnarray}
t & = & t(t')\\
x^{a} & = & x^{a}(t',x^{a'})
...
\]
and since $t' = t'\left(t\right)$, $\partial t'/\partial x^{b} = 0$, hence we obtain an important identity of this coordinate transformation
\begin{equation}
